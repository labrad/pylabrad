...
function sC(g,f,c){var a,b,d,e;g.c=cn(new an(),f.a+1,c.a+1);ap(g.c,0,0,'version 0.0.1');for(d=0;d<f.a;d++){ap(g.c,d+1,0,f[d]);}for(a=0;a<c.a;a++){ap(g.c,0,a+1,c[a]);b=c[a];for(d=0;d<f.a;d++){e=f[d];bp(g.c,d+1,a+1,aC(new bB(),b,e));}}Bj(hr('table'),g.c);}
