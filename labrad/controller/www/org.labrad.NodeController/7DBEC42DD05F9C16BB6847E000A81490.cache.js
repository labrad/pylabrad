...
function CC(g,f,c){var a,b,d,e;g.c=en(new cn(),f.a+1,c.a+1);cp(g.c,0,0,'version 0.0.1');for(d=0;d<f.a;d++){cp(g.c,d+1,0,f[d]);}for(a=0;a<c.a;a++){cp(g.c,0,a+1,c[a]);b=c[a];for(d=0;d<f.a;d++){e=f[d];dp(g.c,d+1,a+1,kC(new lB(),b,e));}}Dj(jr('table'),g.c);}
