...
function tB(d,b,c,a){np(d);d.b=b;d.d=c;d.a=a;d.e=oq(new mq(),Ap(new sp(),'add.png'));Ck(jl(d.e),Ap(new sp(),'add_gray.png'));nm(d.e,vA(new uA(),d));d.g=oq(new mq(),Ap(new sp(),'delete.png'));Ck(jl(d.g),Ap(new sp(),'delete_gray.png'));nm(d.g,zA(new yA(),d));d.c=oq(new mq(),Ap(new sp(),'arrow_refresh.png'));Ck(jl(d.c),Ap(new sp(),'arrow_refresh_gray.png'));nm(d.c,DA(new CA(),d));d.f=aq(new Ep(),'stopped');d.h=Ap(new sp(),'ajax-loader.gif');rr(d.h,false);op(d,d.e);op(d,d.g);op(d,d.c);op(d,d.f);op(d,d.h);return d;}
