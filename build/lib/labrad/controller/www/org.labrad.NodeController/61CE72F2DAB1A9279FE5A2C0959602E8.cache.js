...
function pC(e,c,d,b){var a,f;cq(e);e.b=c;e.d=d;e.a=b;e.e=er(new cr(),qq(new iq(),'add.png'));il(vl(e.e),qq(new iq(),'add_gray.png'));bn(e.e,rB(new qB(),e));e.g=er(new cr(),qq(new iq(),'delete.png'));il(vl(e.g),qq(new iq(),'delete_gray.png'));bn(e.g,vB(new uB(),e));e.c=er(new cr(),qq(new iq(),'arrow_refresh.png'));il(vl(e.c),qq(new iq(),'arrow_refresh_gray.png'));bn(e.c,zB(new yB(),e));e.f=wq(new uq(),'stopped');a=cq(new aq());dq(a,e.e);dq(a,e.g);dq(a,e.c);gq(a,(vp(),wp));is(a,'48 px');f=cq(new aq());dq(f,qq(new iq(),'ajax-loaderbig.gif'));gq(f,(vp(),wp));is(f,'48 px');e.h=rm(new qm());sm(e.h,a);sm(e.h,f);wm(e.h,0);dq(e,e.h);dq(e,e.f);return e;}
...
function aD(g,f,c){var a,b,d,e;g.c=nn(new ln(),f.a+1,c.a+1);kp(g.c,0,0,'version 0.0.1');for(d=0;d<f.a;d++){kp(g.c,d+1,0,f[d]);}for(a=0;a<c.a;a++){kp(g.c,0,a+1,c[a]);b=c[a];for(d=0;d<f.a;d++){e=f[d];lp(g.c,d+1,a+1,oC(new pB(),b,e));}}fk(rr('table'),g.c);}
