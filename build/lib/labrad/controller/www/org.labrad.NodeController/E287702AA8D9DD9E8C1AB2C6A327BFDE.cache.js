...
function pC(e,c,d,b){var a,f;cq(e);e.b=c;e.d=d;e.a=b;e.e=er(new cr(),qq(new iq(),'add.png'));il(vl(e.e),qq(new iq(),'add_gray.png'));bn(e.e,rB(new qB(),e));e.g=er(new cr(),qq(new iq(),'delete.png'));il(vl(e.g),qq(new iq(),'delete_gray.png'));bn(e.g,vB(new uB(),e));e.c=er(new cr(),qq(new iq(),'arrow_refresh.png'));il(vl(e.c),qq(new iq(),'arrow_refresh_gray.png'));bn(e.c,zB(new yB(),e));e.f=wq(new uq(),'stopped');a=cq(new aq());dq(a,e.e);dq(a,e.g);dq(a,e.c);gq(a,(vp(),wp));is(a,'60px');f=cq(new aq());dq(f,qq(new iq(),'ajax-loaderbig.gif'));gq(f,(vp(),wp));is(f,'60px');e.h=rm(new qm());sm(e.h,a);sm(e.h,f);wm(e.h,0);dq(e,e.h);dq(e,e.f);return e;}
